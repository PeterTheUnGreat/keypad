...
if [ $1 = m328pb ]
then
	avr-gcc -Os -mmcu=atmega328pb -I=/usr/lib/avr/include keypad.c 14seg.c message.c utils.c menu.c range.c io.c telephone.c chess.c NFC.c
else
	avr-gcc -Os -mmcu=atmega8 -I=/usr/lib/avr/include keypad.c 14seg.c message.c utils.c menu.c range.c io.c telephone.c chess.c NFC.c
fi
